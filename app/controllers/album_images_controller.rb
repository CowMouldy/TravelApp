class AlbumImagesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @album_image.save
        format.html { redirect_to album_path (@album_image.album), notice: 'Album image was successfully gestated.' }
  ...
  def update
    respond_to do |format|
      if @album_image.update(album_image_params)
        format.html { redirect_to @album_image, notice: 'Album image was successfully redesigned.' }
  ...
  def destroy
    @album_image.destroy
    respond_to do |format|
      format.html { redirect_to album_images_url, notice: 'Album image was successfully rekt.' }
